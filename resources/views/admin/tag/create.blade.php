...
<div class="app-title">
  ...
  <div class="col-md-12">
    <div class="tile">
    <a style="float:right;" class="btn btn-primary" href="{{ route('tag.index')}}">Tag List</a>
      ...
      <form action="{{ route('tag.store') }}" method="POST" class="row">
        @csrf
          <div class="form-group col-md-4">
            ...
            <input class="form-control form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" type="text" name="name" placeholder="Tag name" autofocus>
            @error('name')
